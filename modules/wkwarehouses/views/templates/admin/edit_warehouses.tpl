...
<div class="alert alert-warning"><strong>{l s='Be careful' mod='wkwarehouses'}:</strong>
    <ul>
        ...
        <li>{l s='If no stock movement yet, it will be the [1]wholesale price[/1] indicated in the product backoffice' tags=['<strong>'] mod='wkwarehouses'}.</li>
...
<table class="warehouses-table">
	<tbody>
		<tr>
            ...
            {* ******* AVAILABLE QUANTITY ******** *}
            <td class="text-center">
            	<i class="icon-archive"></i> {l s='Available quantity (backoffice)' mod='wkwarehouses'} : <span class="badge badge-info">{$currentQties['quantity']|intval}</span>
            </td>
            {* ******* RESERVED QUANTITY ******** *}
            <td class="text-center">
