...
class AdminManageWarehousesController extends ModuleAdminController
{
    public function __construct()
    {
        ...
        $this->fields_list = array(
            ...
            'active' => array(
                'title' => $this->l('Visible in Frontoffice'),
                'active' => 'status',
                'align' => 'center',
                'filter_key' => 'a!active',
                'type' => 'bool',
    ...
    public function renderList()
    {
        ...
        $this->displayInformation(
			'- '.$this->l('By hiding a warehouse, it will be just hidden from frontoffice but the backoffice features will remain, so you can manage it internally.')
		);
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'lang' => true,
                    'maxlength' => 200,
                    'hint' => $this->l('Delivery time of this warehouse.')
                ),
                array(
                    'type' => 'text',
                    'label' => $this->l('Phone'),
    ...
    public function initPageHeaderToolbar()
    {
        if (empty($this->display)) {
            $this->page_header_toolbar_btn['new_warehouse'] = array(
                ...
                'desc' => $this->l('Add warehouse', null, null, false),
