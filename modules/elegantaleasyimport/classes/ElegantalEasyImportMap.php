...
class ElegantalEasyImportMap
{
     ...
     * @var array
     */
    private static $defaultMapProducts = array(
        'id_reference' => '0',
        'reference' => '-1',
        'name' => '-1',
        'enabled' => '-1',
     ...
     * @var array
     */
    private static $defaultMapCombinations = array(
        'id_reference' => '0',
        'combination_id' => '-1',
    ...
    {
        $map = array(
            'id_reference' => '<b>' . $module->l('Find product by', 'ElegantalEasyImportMap') . ' "' . str_replace('_', ' ', $module->model->find_products_by) . '"</b>',
            ...
            'attribute_1' => $module->l('Attribute', 'ElegantalEasyImportMap') . ' 1',
            'attribute_2' => $module->l('Attribute', 'ElegantalEasyImportMap') . ' 2',
            'attribute_3' => $module->l('Attribute', 'ElegantalEasyImportMap') . ' 3',
            ...
            'combination_price' => $module->l('Combination price', 'ElegantalEasyImportMap'),
