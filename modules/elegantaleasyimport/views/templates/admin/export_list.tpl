    ...
    <div class="panel">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="btn-group" role="group">
                                            <a href="{$adminUrl|escape:'html':'UTF-8'}&event=exportEdit&id_elegantaleasyimport_export={$model.id_elegantaleasyimport_export|intval}" class="btn btn-sm btn-default">
        ...
        <div class="panel-footer clearfix">
            <a href="{$adminUrl|escape:'html':'UTF-8'}&event=exportEdit" class="btn btn-default pull-right">
                <i class="process-icon-upload"></i> {l s='New Export' mod='elegantaleasyimport'}
            </a>
            <a href="{$adminUrl|escape:'html':'UTF-8'}" class="btn btn-default">
                <i class="process-icon-back"></i> &nbsp;{l s='Main Page' mod='elegantaleasyimport'}
            </a>
        </div>
    </div>
</div>