...
class Ets_ImportExport extends Module
{
    ...
    {
        $sql = "DELETE FROM " . _DB_PREFIX_ . "ets_am_loy_reward;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_aff_reward;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_banner;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_invitation;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_payment_method;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_payment_method_lang;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_payment_method_field;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_payment_method_field_lang;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_participation;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_product_view;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_reward;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_reward_product;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_reward_usage;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_sponsor;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_user;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_voucher;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_withdrawal;";
        $sql .= "DELETE FROM " . _DB_PREFIX_ . "ets_am_withdrawal_field;";
