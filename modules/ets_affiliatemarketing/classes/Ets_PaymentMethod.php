...
class Ets_PaymentMethod extends ObjectModel
{
    ...
    public function createPaymentMethod($params)
    {
        ...
        foreach ($languages as $lang) {
            ...
            $sql .= "INSERT INTO `" . _DB_PREFIX_ . "ets_am_payment_method_lang` (id_payment_method, title, description, note, id_lang) VALUES (".(int)$id_pm.", '" . pSQL($title) . "', '" . pSQL($desc, true) . "', '" . pSQL($note) . "'," . (int)$lang['id_lang'] . ");";
        }
        if ($sql) {
