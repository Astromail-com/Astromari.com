        ...
        return array(
            ...
            'config' => array(
                ...
                'ETS_AM_RECALCULATE_COMMISSION' => array(
                    'type' => 'switch',
                    'col' => 3,
                    'label' => $this->l('Recalculate commission when admin add/edit total order value or add/edit discount of order'),
                    'default' => '0',
                ),
        ...
        return array(
            ...
            'config' => array(
                ...
                'ETS_AM_REF_VOUCHER_TYPE' => array(
                    ...
                    'values' => array(
                        array(
                            'title' => $this->l('Fixed voucher code').Module::getInstanceByName('ets_affiliatemarketing')->displayHtml($this->l('Configure discounts'),'a',null,null,$this->context->link->getAdminLink('AdminCartRules')),
                            'value' => 'FIXED',
        ...
        return array(
            ...
            'config' => array(
                ...
                'ETS_AM_AFF_VOUCHER_TYPE' => array(
                    ...
                    'values' => array(
                        array(
                            'title' => $this->l('Fixed voucher code (general voucher code used for all customers)').Module::getInstanceByName('ets_affiliatemarketing')->displayHtml($this->l('Configure discounts'),'a',null,null,$this->context->link->getAdminLink('AdminCartRules')),
                            'value' => 'FIXED',
                            'default' => true,
