...
*}
<div id="ets-am-withdraw-table" class="table-response table-responsive">
    <div class="text-right">
        <a href="{$ets_am_withdraw_url nofilter}" class="btn btn-primary"> {l s="Withdraw reward to bank" mod='ets_affiliatemarketing'}</a>
    </div>
