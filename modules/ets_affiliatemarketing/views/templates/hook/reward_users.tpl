	...
	<table class="table table-bordered eam-datatables">
		<thead>
			<tr>
				<th>
					#
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="ASC" data-col="id_customer" data-sort="asc"><i class="fa fa-sort-asc"></i></a>
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="DESC" data-col="id_customer" data-sort="desc"><i class="fa fa-sort-desc"></i></a>
				</th>
				<th>
					{l s='Customer' mod='ets_affiliatemarketing'}
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="ASC" data-col="firstname" data-sort="asc"><i class="fa fa-sort-asc"></i></a>
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="DESC" data-col="firstname" data-sort="desc"><i class="fa fa-sort-desc"></i></a>
				</th>
				<th>
					{l s='Reward balance' mod='ets_affiliatemarketing'}
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="ASC" data-col="reward_balance" data-sort="asc"><i class="fa fa-sort-asc"></i></a>
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="DESC" data-col="reward_balance" data-sort="desc"><i class="fa fa-sort-desc"></i></a>
				</th>
				<th>
					{l s='Loyalty rewards' mod='ets_affiliatemarketing'}
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="ASC" data-col="loy_rewards" data-sort="asc"><i class="fa fa-sort-asc"></i></a>
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="DESC" data-col="loy_rewards" data-sort="desc"><i class="fa fa-sort-desc"></i></a>
				</th>
				<th>
					{l s='Sponsorship / Referral rewards' mod='ets_affiliatemarketing'}
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="ASC" data-col="ref_rewards" data-sort="asc"><i class="fa fa-sort-asc"></i></a>
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="DESC" data-col="ref_rewards" data-sort="desc"><i class="fa fa-sort-desc"></i></a>
				</th>
				<th>
				...
				<th>
					...
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="ASC" data-col="ref_orders" data-sort="asc"><i class="fa fa-sort-asc"></i></a>
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="DESC" data-col="ref_orders" data-sort="desc"><i class="fa fa-sort-desc"></i></a>
				</th>
				<th>
					{l s='Affiliate rewards' mod='ets_affiliatemarketing'}
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="ASC" data-col="aff_rewards" data-sort="asc"><i class="fa fa-sort-asc"></i></a>
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="DESC" data-col="aff_rewards" data-sort="desc"><i class="fa fa-sort-desc"></i></a>
				</th>
				<th>
					{l s='Affiliate orders' mod='ets_affiliatemarketing'}
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="ASC" data-col="aff_orders" data-sort="asc"><i class="fa fa-sort-asc"></i></a>
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="DESC" data-col="aff_orders" data-sort="desc"><i class="fa fa-sort-desc"></i></a>
				</th>
				<th style="gfg">
					{l s='Withdrawals' mod='ets_affiliatemarketing'}
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="ASC" data-col="total_withdraws" data-sort="asc"><i class="fa fa-sort-asc"></i></a>
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="DESC" data-col="total_withdraws" data-sort="desc"><i class="fa fa-sort-desc"></i></a>
				</th>
				<th>
					{l s='Status' mod='ets_affiliatemarketing'}
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="ASC" data-col="user_status" data-sort="asc"><i class="fa fa-sort-asc"></i></a>
					<a href="javascript:void(0)" class="js-sort-user-reward" data-toggle="tooltip" data-placement="top" title="DESC" data-col="user_status" data-sort="desc"><i class="fa fa-sort-desc"></i></a>
				</th>
				<th>
				...
				{foreach $users.results as $user}
					<tr>
						...
						<td class="text-center">
							<button type="button" class="btn btn-default btn-action"><i class="fa fa-search"></i></button>
						</td>
					</tr>
				{/foreach}
			{else}
	...
	<div class="box-filter">
		<form id="eamFormFilterRewardUser" onsubmit="return false;">
			<div class="row">
				...
				<div class="col-lg-1">
					<button type="reset" class="btn btn-default btn-block"><i class="fa fa-undo"></i> {l s='Reset' mod='ets_affiliatemarketing'}</button>
				</div>
			</div>
		</form>
