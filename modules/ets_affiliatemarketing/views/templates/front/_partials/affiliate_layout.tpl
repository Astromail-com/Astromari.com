            ...
            {if isset($alert_type) && $alert_type && $alert_type != 'REGISTERED'}
                <div class="mt-20 px-20">
                    ...
                    {elseif $alert_type == 'PROGRAM_SUSPENDED'}
                        <div class="alert alert-warning">
                            {l s='You has been suspended' mod='ets_affiliatemarketing'}
                        </div>
