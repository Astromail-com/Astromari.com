...
class EtsAwuManufacturer extends ObjectModel
{
     /**
     * @var int
     */
    public $id_ets_awu_manufacturer;
     /**
     * @var int
     */
    ...
    public static $definition = array(
        'table' => 'ets_awu_manufacturer',
        'primary' => 'id_ets_awu_manufacturer',
        'multilang_shop' => false,
        'fields' => array(
            'id_ets_awu_manufacturer' => array(
                'type' => self::TYPE_INT,
    ...
    public static function getSeoManufacturer($id_manufacturer, $context = null, $id_lang = null){
        ...
        if($id_lang){
            ...
            return Db::getInstance()->getRow("SELECT * 
                                        FROM `"._DB_PREFIX_."ets_awu_manufacturer` 
