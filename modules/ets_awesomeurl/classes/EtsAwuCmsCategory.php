...
class EtsAwuCmsCategory extends ObjectModel
{
     /**
     * @var int
     */
    public $id_ets_awu_cms_category;
     /**
     * @var int
     */
    ...
    public static $definition = array(
        'table' => 'ets_awu_cms_category',
        'primary' => 'id_ets_awu_cms_category',
        'multilang_shop' => false,
        'fields' => array(
            'id_ets_awu_cms_category' => array(
                'type' => self::TYPE_INT,
    ...
    public static function getSeoCmsCategory($id_cms_category, $context = null, $id_lang = null){
        ...
        if($id_lang){
            return Db::getInstance()->getRow("SELECT * 
                                        FROM `"._DB_PREFIX_."ets_awu_cms_category` 
