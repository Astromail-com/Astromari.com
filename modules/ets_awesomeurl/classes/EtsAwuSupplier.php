...
class EtsAwuSupplier extends ObjectModel
{
     /**
     * @var int
     */
    public $id_ets_awu_supplier;
     /**
     * @var int
     */
    public $id_supplier;
    ...
    public static $definition = array(
        'table' => 'ets_awu_supplier',
        'primary' => 'id_ets_awu_supplier',
        'multilang_shop' => false,
        'fields' => array(
            'id_ets_awu_supplier' => array(
                'type' => self::TYPE_INT,
    ...
    public static function getSeoSupplier($id_supplier, $context = null, $id_lang = null){
        ...
        if($id_lang){
            ...
            return Db::getInstance()->getRow("SELECT * 
                                        FROM `"._DB_PREFIX_."ets_awu_supplier` 
