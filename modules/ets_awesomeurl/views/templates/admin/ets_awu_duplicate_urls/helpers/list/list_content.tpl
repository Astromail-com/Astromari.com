            ...
            {foreach $fields_display AS $key => $params}
                ...
                {/if}
					...
					{elseif isset($params.activeVisu)}
						{if $tr.$key}
                            <i class="icon-check-ok"></i> {l s='Enabled' mod='ets_awesomeurl'}
						{else}
							<i class="icon-remove"></i> {l s='Disabled' mod='ets_awesomeurl'}
                        {/if}
					...
					{elseif isset($params.type) && $params.type == 'percent'}
						{$tr.$key nofilter} {l s='%' mod='ets_awesomeurl'}
					{elseif isset($params.type) && $params.type == 'bool'}
            {if $tr.$key == 1}
                            {l s='Yes' mod='ets_awesomeurl'}
                        {elseif $tr.$key == 0 && $tr.$key != ''}
                            {l s='No' mod='ets_awesomeurl'}
                        {/if}
    ...
    <tr>
        <td class="list-empty" colspan="100%">
            <div class="alert alert-info" style="margin-top: 15px;">
                {l s='Good! No duplicates found' mod='ets_awesomeurl'}
            </div>
        </td>
    </tr>
{/if}
