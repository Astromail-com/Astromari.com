    ...
    <div class="row">
        <div class="col-lg-9">
            {if $input.name == 'description'}
                ...
                {/if}
            {/if}
            <div class="ets-seo-customize-item hhhhhhhhh js-ets-seo-customize-item js-ets-seo-tab-{if $input.name == 'description' || $input.name == 'keywords' || $input.name == 'url_rewrite'}setting{else}content active{/if}">
                {$smarty.block.parent}
            </div>
        </div>
    </div>
