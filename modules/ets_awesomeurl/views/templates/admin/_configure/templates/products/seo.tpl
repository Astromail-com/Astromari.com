...
<div id="product-seo" class="panel product-tab">
	...
	<div class="panel-footer">
		...
		<button type="submit" name="submitAddproduct" class="btn btn-default pull-right" disabled="disabled"><i class="process-icon-loading"></i> {l s='Save' mod='ets_awesomeurl'}</button>
		<button type="submit" name="submitAddproductAndStay" class="btn btn-default pull-right" disabled="disabled"><i class="process-icon-loading"></i> {l s='Save and stay' mod='ets_awesomeurl'}</button>
	</div>
</div>
