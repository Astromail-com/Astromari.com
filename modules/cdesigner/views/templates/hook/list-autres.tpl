...
*}
<div class="panel"><h3></i> {l s='autres' mod='cdesigner'}
	...
	<div class="panel-footer">
		<a class="btn btn-default pull-right" href="{$link->getAdminLink('AdminModules')|escape:'htmlall':'UTF-8'}&configure=cdesigner&addItem=1&category={$category|escape:'htmlall':'UTF-8'}"><i class="process-icon-new"></i> New  device</a>
	</div>
</div>
...
<script language='javascript'>
	$('.cls-autres>div').each(function(index, el) {
