...
*}
<div class="panel" style="clear:both;margin-top:50px"><h3></i> {l s='Type Of case' mod='cdesigner'}
						...
						<div class="col-md-8">
							...
							<div class="btn-group-action pull-right">
								<a class="btn btn-default" title="Edit"
									href="{$link->getAdminLink('AdminModules')|escape:'htmlall':'UTF-8'}&configure=cdesigner&id_cdesigner_type={$item.id_cdesigner_type|escape:'htmlall':'UTF-8'}&category={$category|escape:'htmlall':'UTF-8'}&id_phone={$id_phone|escape:'htmlall':'UTF-8'}">
									<i class="icon-edit"></i>
								</a>
								<a class="btn btn-default" title="Delete"
									href="{$link->getAdminLink('AdminModules')|escape:'htmlall':'UTF-8'}&configure=cdesigner&delete_id_cdesigner_type={$item.id_cdesigner_type|escape:'htmlall':'UTF-8'}&id_cdesigner={$id_phone|escape:'htmlall':'UTF-8'}&category={$category|escape:'htmlall':'UTF-8'}">
