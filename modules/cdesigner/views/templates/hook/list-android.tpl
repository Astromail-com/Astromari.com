...
*}
<div class="panel"><h3></i> {l s='android' mod='cdesigner'}
	...
	<div id="itemsContent">
		<div id="items" class="cls-android">
	...
	<div class="panel-footer">
		<a class="btn btn-default pull-right" href="{$link->getAdminLink('AdminModules')|escape:'htmlall':'UTF-8'}&configure=cdesigner&addItem=1&category={$category|escape:'htmlall':'UTF-8'}"><i class="process-icon-new"></i> New android device</a>
	</div>
</div>
</div>
<div class="col-md-4">
...
<script language='javascript'>
	$('.cls-android>div').each(function(index, el) {
