...
class CdesignerImagesModel extends ObjectModel
{
	public $image;
	public $tags;
	public $id_tag;
	...
	public static $definition = array(
		...
		'fields' => array(
			...
			'id_tag' =>	array('type' => self::TYPE_STRING, 'lang' => false, 'validate' => 'isCleanHtml', 'size' => 255),
		)
	);
	...
	public function getImages( $id_lang = '')
	{
		...
		return Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
				SELECT  a.`id_img` , a.`image`, a.`id_tag`, b.`tags`
	...
	public function getImagesWithTags( $id_lang = '')
	{
		if( empty ($id_lang ) )
			$id_lang = (int) Configuration::get('PS_LANG_DEFAULT');
		//$lang = new Language( (int)Configuration::get('PS_LANG_DEFAULT') );
	...
	{
		$req = 'SELECT `id_img`
				FROM `'._DB_PREFIX_.'cdesigner_defaults_img`
