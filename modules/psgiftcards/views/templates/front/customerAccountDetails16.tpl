...
{capture name=path}
    <a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
        {l s='My account' mod='psgiftcards'}
    </a>
    <span class="navigation-pipe">{$navigationPipe}</span>
    <span class="navigation_page">{l s='Gift cards' mod='psgiftcards'}</span>
{/capture}

{block name='page_content'}
<div>
    <h1 class="page-heading bottom-indent">{l s='My Gift cards' mod='psgiftcards'}</h1>
    <p class="info-title">{l s='Here are the gift cards you\'ve placed since your account was created. You can configure them or consult their details.' mod='psgiftcards'}</p>
    ...
    <div id="giftcardList">
        {* GIFTCARD TITLE LIST *}
        <div v-if="giftcards == ''">
            <p class="alert alert-info">{l s='You haven\'t ordered any gift cards yet.' mod='psgiftcards'}</p>
        </div>
                            ...
                            <form :id="'giftcardForm_' + giftcard.id" v-on:keydown="onChange(giftcard.id, index)" v-on:change="onChange(giftcard.id, index)" v-on:submit.prevent novalidate>
                                ...
                                <div class="col-md-6 left">
                                    <div class="form-group row">
                                        <label class="col-md-4 form-control-label">{l s='Recipient\'s name' mod='psgiftcards'} <label class="require">*</label></label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-4 form-control-label">{l s='Your name' mod='psgiftcards'} <label class="require">*</label></label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-4 form-control-label">{l s='Add a text' mod='psgiftcards'}</label>
                                        <div class="col-md-8">
                                    ...
                                    <article class="alert alert-danger" role="alert" data-alert="warning">
                                        ...
                                        <ul v-for="(value, key) in checkFields[giftcard.id]">
                                            <li class="giftcards-list16" v-if="key =='validateRecipientName' && value !=true">(( value ))</li>
                                            <li class="giftcards-list16" v-if="key =='validateBuyerName' && value !=true">(( value ))</li>
                                            <li class="giftcards-list16" v-if="key =='recipientMail' && value !=true">(( value ))</li>
                                            <li class="giftcards-list16" v-if="key =='sendDate' && value !=true">(( value ))</li>
                                        </ul>
                                    </article>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 right">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="switch-field large">
                                                <input type="radio" class="giftcard-type noUniform" :id="'giftcard_type_' + giftcard.id + '_on'" name="giftcard_type" value="1" v-model="giftcards[index].type" :checked="giftcard.type == 1" :disabled="giftcard.id_state == 3 || giftcard.id_state == 4 || giftcard.id_state == 5"/>
                                                <label :for="'giftcard_type_' + giftcard.id + '_on'">{l s='Send by mail' mod='psgiftcards'}</label>
                                                <input type="radio" class="giftcard-type noUniform" :id="'giftcard_type_' + giftcard.id + '_off'" name="giftcard_type" value="0" v-model="giftcards[index].type" :checked="giftcard.type == 0" :disabled="giftcard.id_state == 3 || giftcard.id_state == 4 || giftcard.id_state == 5"/>
                                    ...
                                    <div :id="'mailForm_' + giftcard.id" v-show="giftcard.type == 1">
                                        <div class="form-group row">
                                            <label class="col-md-4 form-control-label">{l s='Recipient\'s email' mod='psgiftcards'} <label class="require">*</label></label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="switch-field medium">
                                                    <input type="radio" class="giftcard-date noUniform" :id="'giftcard_send_' + giftcard.id + '_on'" name="giftcard_send" value="1" v-model="giftcards[index].sendLater" :checked="giftcard.sendLater == 1" :disabled="giftcard.id_state == 3 || giftcard.id_state == 4 || giftcard.id_state == 5"/>
                                                    <label :for="'giftcard_send_' + giftcard.id + '_on'">{l s='Later' mod='psgiftcards'}</label>
                                                    <input type="radio" class="giftcard-date noUniform" :id="'giftcard_send_' + giftcard.id + '_off'" name="giftcard_send" value="0" v-model="giftcards[index].sendLater" :checked="giftcard.sendLater == 0" :disabled="giftcard.id_state == 3 || giftcard.id_state == 4 || giftcard.id_state == 5"/>
                                        ...
                                        <div :id="'dateField_' + giftcard.id" v-show="giftcard.sendLater == 1">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input class="form-control" name="send_date" type="date" v-model="giftcards[index].send_date" required="" placeholder="MM/DD/YYYY" :readonly="giftcard.id_state == 4 || giftcard.id_state == 5">
                                                    <span class="form-control-comment">(Ex. : 31-05-1970)</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <article  v-if="giftcard.id_state == 2 && giftcard.hasChanged == 0" class="alert alert-warning" role="alert" data-alert="warning">
                                            <ul>
                ...
                <tr v-if="giftcard.id_state == 1" class="giftcard-content giftcard-hide">
                    <td colspan="6">
                        <article class="alert alert-info" role="alert" data-alert="warning">
                            <ul>
                                <li class="giftcards-list16" style="background: none">{l s='Before configuring your gift card, the payment needs to be validated' mod='psgiftcards'}</li>
                            </ul>
                        </article>
                    </td>
                </tr>
...
<ul class="footer_links clearfix">
    <li>
        <a class="btn btn-default button button-small" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
            <span>
                <i class="icon-chevron-left"></i> {l s='Back to Your Account' mod='psgiftcards'}
            </span>
        </a>
    </li>
    <li>
        <a class="btn btn-default button button-small" href="{$base_dir}">
            <span><i class="icon-chevron-left"></i> {l s='Home' mod='psgiftcards'}</span>
        </a>
    </li>
</ul>
...
<script type="text/javascript">
    ...
    var pdf_controller = "{/literal}{$pdf_controller|escape:'htmlall':'UTF-8'}{literal}";
