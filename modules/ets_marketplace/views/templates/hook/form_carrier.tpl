                                ...
                                <div class="form-group row">
                                    {foreach from=$languages item='language'}
                                        <div class="translatable-field lang-{$language.id_lang|intval}" {if $language.id_lang!=$id_lang_default} style="display:none;"{/if}>
                                            <div class="col-lg-11">
                                                <input class="form-control" id="delay_{$language.id_lang|intval}" name="delay_{$language.id_lang|intval}" value="{if isset($delay[$language.id_lang])}{$delay[$language.id_lang]|escape:'html':'UTF-8'}{else}{/if}"  type="text" />
                                            </div>
                                            <div class="col-lg-1">
