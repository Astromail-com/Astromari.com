...
class AdminMarketPlaceRatingsController extends ModuleAdminController
{
    ...
    public function _renderRatings()
    {
        if(!Module::isInstalled('productcomments') && !Module::isInstalled('ets_reviews'))
            return $this->module->displayWarning($this->l('You have to install the Product Comments module of PrestaShop or Trusted reviews, ratings, Q&A module of ETS-Soft'));
        $fields_list = array(
            'id_comment' => array(
                'title' => $this->l('ID'),
                'width' => 40,
