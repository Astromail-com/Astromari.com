...
class Ets_MarketPlaceProductsModuleFrontController extends ModuleFrontController
{
    ...
    public $product;
    public $mpProduct =null;
    public $list_field_approve = array();
    public $errors = array();
    public $seller;
    public $combinations;
    ...
    public function _checkValidateProduct()
    {
        ...
        elseif(!Validate::isUnsignedFloat($price_excl))
            $this->errors[]= $this->module->l('Product price is not valid','products');
    ...
    public function _submitSaveProduct()
    {
        ...
        if($this->mpProduct && in_array('price',$this->list_field_approve))
        {
            ...
            if($this->product->price!=$price_excl || (in_array('tax',$this->seller_product_information) && $this->product->id_tax_rules_group!= $id_tax_rules_group))
