...
{block name="input_row"}
    <div class="row js-ets-seo-tab-{if $input.name == 'meta_title' || $input.name == 'meta_description' || $input.name == 'meta_keywords'}setting{else}content active{/if}">
        <div class="col-lg-9">
...
{block name="leadin"}
    <div style="{if $active}display:none{/if}">
        <p class="alert alert-warning">
            {l s='Your page will be saved as a draft' mod='ets_awesomeurl'}
        </p>
    </div>
{/block}
